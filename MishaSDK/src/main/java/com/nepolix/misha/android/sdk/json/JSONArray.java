...
class JSONArray
{
	 ...
	 /**
		...
		*
		* @param copyFrom
		* 				a collection whose values are of supported types. Unsupported values are not
		* 				permitted and
		* 				will yield an array in an inconsistent state.
		*/
	 ...
	 /**
		...
		* 				{@link
		* 				JSONObject#NULL}, or {@code null}. May not be {@link Double#isNaN() NaNs} or {@link
		* 				Double#isInfinite() infinities}. Unsupported values are not permitted and will cause
		* 				the
	 ...
	 /**
		...
		*
		* @throws JSONException
		* 				if this array has no $value at {@code index}, or if that $value is the {@code null}
